...
public class FollowUI : MonoBehaviour{
    ...
    void Update()
    {
        ...
        if(scaleWith)transform.localScale=new Vector2(targetObj.transform.localScale.x*xscale,targetObj.transform.localScale.y*yscale);
        }
    }
